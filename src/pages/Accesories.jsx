...
const Accesories = () => {  
  ...
  useEffect(()=>{
    fetch("https://ecommerce-backend-git-main-maheshv99.vercel.app/accesoriesData")
    .then(res=>res.json())
    .then(json=>setaccesoriesData(json))
    .catch(err=>console.log("error"))
  },[])
  useEffect(()=>{
    fetch("https://ecommerce-backend-git-main-maheshv99.vercel.app/accesoriesMainPic")
    .then(res=>res.json())
